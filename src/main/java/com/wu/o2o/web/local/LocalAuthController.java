...
import com.wu.o2o.dto.LocalAuthExecution;
import com.wu.o2o.entity.LocalAuth;
import com.wu.o2o.entity.PersonInfo;
import com.wu.o2o.enums.LocalAuthStateEnum;
import com.wu.o2o.exceptions.LocalAuthOperationException;
import com.wu.o2o.service.LocalAuthService;
...
public class LocalAuthController {
	...
	private Map<String, Object> logincheck(HttpServletRequest request) {
		...
		if (needVerify && !CodeUtil.cheakVerifyCode(request)) {
			modelMap.put("success", false);
			modelMap.put("errMsg", "输入了错误的验证码");
			return modelMap;
		}
